...
<div width="100%"
    ...
    <div style="max-width: 700px; padding:50px 0;  margin: 0px auto; font-size: 14px">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            ...
            <tr>
                <td>
                    <div style="display: none"> Hello {{ $user->name }}, You are receiving this email because
                        we received a password reset request for your </div>
                ...
                <tr>
                    <td>
                        ...
                        <p>You are receiving this email because we received a password reset request for your
                            ...
                            otherwise, click on the <b>"Link Below"</b> to reset your account password.</p>

                        <a style="word-break: break-all;"
                           href="{{ url('auth/reset-password/' . $token) }}">{{ url('auth/reset-password/' . $token) }}</a>
                    </td>
                </tr>
                </tbody>
            </table>
